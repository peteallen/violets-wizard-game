...
const CURRENT_ALLOWLIST = Object.freeze([
  ...
  ...allowMany(ARCHITECTURE_RULES.GENERIC_CHARACTER_IMPORT, 'src/game/render/SetPieceRenderer.js', [
    './OwlRenderer.js',
  ]),
  ...allowMany(ARCHITECTURE_RULES.GENERIC_CHARACTER_IMPORT, 'src/game/render/StorybookTitleRenderer.js', [
    './OwlRenderer.js',
  ]),
