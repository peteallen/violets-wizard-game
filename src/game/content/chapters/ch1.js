...
export const chapter1 = {
  ...
  npcs: idMap([
    ...
    { id: 'npc.tailor', displayName: 'Madam Malkin', puppet: 'puppet.tailor', portrait: 'portrait.tailor', voiceRole: 'tailor', scale: 1, hitRadius: 88, defaultPose: 'idle', controller: { kind: 'static' }, defaultTalk: null },
