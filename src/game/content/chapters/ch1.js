      ...
      name: {
        ...
        choices: [
          ...
          },
          {
            ...
            icon: 'name-star',
            caption: 'Star',
            actions: [{ type: 'character.set', field: 'pet.name', value: 'Star' }],
            next: 'recordName',
          },
        ],
      },
  ...
  rooms: roomMap([
    {
      ...
      exits: [
        {
          id: 'bedroom.exit',
          hitArea: rect(20, 385, 120, 180),
          to: { room: 'ch1.leaky', spawn: 'leaky.entry' },
          icon: 'door',
          transition: 'ink',
...
export const chapter1Map = {
  ...
  locations: [
    { id: 'map.ch1.diagonStreet', icon: 'street', caption: 'Explore', when: when({ allFlags: ['ch1.diagonReached'] }), onSelect: [travel('ch1.diagonStreet', 'west')] },
    { id: 'map.ch1.ollivanders', icon: 'wand-shop', caption: 'Wand', when: when({ allFlags: ['ch1.satchelReceived'] }), onSelect: [flagSet('ch1.mapUsed'), travel('ch1.ollivanders', 'entry')] },
    { id: 'map.ch1.malkins', icon: 'robes-shop', caption: 'Robes', when: when({ allFlags: ['ch1.wandChosen'] }), onSelect: [travel('ch1.malkins', 'entry')] },
    { id: 'map.ch1.menagerie', icon: 'pet-shop', caption: 'Pet', when: when({ allFlags: ['ch1.trimChosen'] }), onSelect: [travel('ch1.menagerie', 'entry')] },
  ],
};
