...
export const ollivandersRoom = freezePureData({
  ...
  hotspots: [
    ...
    {
      id: 'ollivanders.box2ToWand1',
      kind: 'action',
      hitArea: circle(782, 382, 90),
      approach: { x: 690, y: 610, facing: 'right' },
      when: when({ noFlags: ['ch1.wandTry1'] }),
      presentation: { icon: 'wand', glow: 'none' },
      repeat: 'once',
      requiredSpell: null,
      onInteract: [setPiecePlay('sp.wandChaos1')],
    },
    {
      id: 'ollivanders.box3ToWand1',
      kind: 'action',
