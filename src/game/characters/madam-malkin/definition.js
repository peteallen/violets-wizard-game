...
const MADAM_MALKIN_ALIASES = Object.freeze({ talk: 'speaking' });
...
export const madamMalkinCharacterDefinition = defineCharacter({
  id: 'character.madam-malkin',
  metadata: {
    displayName: 'Madam Malkin',
    kind: 'human',
    voiceRole: 'tailor',
  },
  ...
  assets: characterImageAssets('madam-malkin', [
    'default/neutral.png',
    'default/blink.png',
    'default/talk-a.png',
    'default/talk-b.png',
...
export const madamMalkinCharacterReview = defineCharacterReview([
