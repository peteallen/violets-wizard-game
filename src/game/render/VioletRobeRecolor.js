...
// The approved source sheets use a violet trim centered near 270 degrees.
// Keeping this range narrower than blue and magenta protects the blue-black
// robe, warm hair and skin while still catching the tie and shoe accents.
...
/**
 * Parses an opaque CSS hex color and returns its normalized RGB value.
 * Target alpha is deliberately unsupported because frame alpha is preserved.
 */
...
/**
 * Selectively recolors Violet's authored purple robe trim. Returned canvases
 * are cached by source object and normalized target color and should be treated
 * as immutable drawImage sources.
 */
