...
> **Status 2026-07-17:** the complete route is playable on `main`. The approved
> Phase 2 pass described below is active but not yet complete. Its reliability
> foundation is deployed: the Great Hall targets are unambiguous, the barrier's
> live and reloaded platform positions agree, chapter completion is atomic, old
> saves migrate safely, and dialogue, quest, reward, and set-piece progress now
> resumes without replaying hidden actions or duplicating story outcomes.
...
**Beats:** her first spellbook arrives as owl post → Charms class — Professor Flitwick teaches **Lumos** first: the game's first **incantation assembly** (five friendly letters, L-U-M-O-S, matching rune slots, tiles sounding out as they land, wand brightening with each — see GAME_DESIGN.md's learning layer). Then **Wingardium Leviosa** (the feather scene she knows by heart), performed as chanted *syllable* tiles since the word is enormous — "WIN · GAR · DIUM… LEVI · O · SA" — her feather lifts a little with every syllable and sails on the completed chant, always succeeding, with maximum sparkle → **the lost toad**: Neville has lost Trevor; she explores three night corridors using Lumos to reveal a trail, finds Trevor, and returns him for 10 house points and a toad token. The hidden Circe card rewards corridor exploration. An unnamed friendly ghost then offers the sleeping **Fix the book** side quest and a Bertie Bott card while Reparo remains future magic. Violet stays silent throughout, with the player, live lettering, animation, and effects carrying her casts.
...
**Asset list:** common-room autumn variant plus 4 new rooms (Charms classroom, 3 night corridors); castle map and five destination paintings; props: spellbook parcel, lantern, feather, wet footprints, ribbon clue, reflected eyes, distinct Trevor, torn ghost book, sleeping star, and toad token; Field Kit spellbook, cards, ribbon, rune, and chant shells; Circe and Bertie Bott card portraits; voices: narrator/home letter, Flitwick, Neville, and unnamed friendly ghost, with no Violet voice; music: classroom brightness, night-corridor hush (cozy, not scary); SFX: rising rune notes and comic fizzles, Lumos bloom, Leviosa harp gliss, directional toad croaks, and class ambience.
