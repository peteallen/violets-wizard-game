...
1. **The letter.** Violet's own bedroom, sunny morning. An owl taps the window (tutorial: tap the owl — the only glowing thing on screen). The window opens, the letter drops — and the envelope reads **VIOLET** in big golden script. She taps *her own name* to break the seal (the game's very first literacy beat, disguised as the game's very first wish-fulfillment beat). It unfolds and the **narrator reads its complete visible wording aloud** (original text, not the book's): *"Dear Violet, you are invited to Hogwarts School of Witchcraft and Wizardry. Your place is waiting. Bring your brightest curiosity."* Caption: "HOGWARTS!" This is the first ten seconds of the game and it must be perfect.
