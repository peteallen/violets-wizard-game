# Chapter 3 corridor-two destination vignette — native v1
...
normalized the canvas to 1176×1400 without cropping or aspect distortion;
...
Primary request: Create one new castle-corridor destination card in the exact visual family of Image 1. In the upper approximately 70 percent, paint a compact stone passage whose defining feature is exactly two clearly separated dark arched wall alcoves. A broad, well-lit stone pier must visibly divide the two recesses so they read as two distinct empty alcoves rather than one opening. Include no other alcove, doorway, curtain, armor, or focal prop. The lower approximately 23 percent must be one completely blank, calm warm-parchment label band with no decoration that could be mistaken for a mark or character.
...
Color palette: Honey parchment, aged gold, dark blackberry plum, warm amber stone, dark oak, muted burgundy, and restrained blue-violet shadow. Do not use chroma green anywhere in the card.
Constraints: exactly two dark alcoves, both empty and visibly separate; no people, children, adults, faces, silhouettes, hands, characters, creatures, animals, birds, portraits, statues, armor, curtains, doors, text, letters, numbers, runes, routes, stars, checks, locks, logos, watermark, signature, state markers, clues, progress cues, interaction sparkles, `Here`, `Next`, copied film-set composition, or cropped card edges.
Avoid: a third recess, a joined double doorway, secret-route imagery, modern software UI, flat vector art, cel shading, photorealism, 3D rendering, perfect rectangles, bulky borders, clutter in the label band, green fringe, background variation, and any shadow outside the card.
