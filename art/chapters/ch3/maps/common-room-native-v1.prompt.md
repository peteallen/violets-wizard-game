# Chapter 3 common-room destination vignette — native v1
...
2. `art/raw/ch2-gryffindor-common-room-v2.png`

The first reference is the exact destination-card family and geometry anchor.
The second reference supplies only the recognizable common-room materials,
furnishings, and painterly place identity.
...
Input images: Image 1 is the exact family and geometry reference. Match its single irregular warm-parchment destination card, slim aged-gold and dark-plum rim, portrait proportions, upper place-painting area, calm blank lower label band, tactile gouache-and-colored-pencil finish, and straight-on presentation. Image 2 supplies only the Gryffindor common room's recognizable scarlet seating, glowing hearth, curved honey-stone and dark-oak interior, layered rugs, and richly painted material detail; do not reproduce its widescreen framing.
Primary request: Create one new common-room destination card in the exact visual family of Image 1. In the upper approximately 70 percent, paint a compact, readable miniature of the cozy circular tower common room: a pair of deep-scarlet seats, a welcoming glowing stone hearth, warm dark-oak details, and one tall window showing a gentle autumn afternoon with copper and amber leaves outside. The lower approximately 23 percent must be one completely blank, calm warm-parchment label band with no decoration that could be mistaken for a mark or character.
...
Color palette: Honey parchment, aged gold, dark blackberry plum, deep scarlet, warm hearth amber, dark oak, autumn copper, and restrained blue-violet shadow. Do not use chroma green anywhere in the card.
Constraints: no people, children, adults, faces, silhouettes, hands, creatures, animals, birds, portraits, statues, text, letters, numbers, runes, routes, stars, checks, locks, logos, watermark, signature, state markers, progress cues, interaction sparkles, `Here`, `Next`, copied film-set composition, or cropped card edges.
Avoid: modern software UI, flat vector art, cel shading, photorealism, 3D rendering, perfect rectangles, bulky borders, oversized furniture, clutter in the label band, green fringe, background variation, and any shadow outside the card.
