...
const EXPECTED_WALKTHROUGH_TRACE = [
  ...
  },
  {
    ...
    events: [
      ...
      'state.changed:chapter-complete:progress.completedChapters,progress.highestUnlockedChapter,progress.questFlags.ch1.chapterCardSeen,progress.questFlags.ch1.complete,resume',
